        ...
        <section className={styles['comment-section']}>
          ...
          <div className={styles['comment']}>
            <p style={{ fontSize: '14px', marginBottom: '8px' }}>
              Postado por fulano em 01/01/2020:{' '}
            </p>
            <p>Eu conheci george oswell, era um rapaz gente fina</p>
          </div>
          <div className={styles['comment']}>
            <p style={{ fontSize: '14px', marginBottom: '8px' }}>
              Postado por fulano em 01/01/2020:{' '}
            </p>
            <p>1984 é um livro muito bom, eu mesmo nunca li mas vou ler</p>
          </div>
          <div className={styles['comment']}>
            <p style={{ fontSize: '14px', marginBottom: '8px' }}>
              Postado por fulano em 01/01/2020:{' '}
            ...
            <p>
              Li esse livro em uma hora, achei que tinha algo a ver com o big
              brother mesmo, mas é outra coisa
            </p>
          </div>
        </section>
      </div>
